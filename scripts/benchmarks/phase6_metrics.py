"""(deprecated) Legacy filename. Use `retrieval_metrics.py` instead.

This module was renamed; the canonical evaluation helpers now live in
`scripts/benchmarks/retrieval_metrics.py` (no "phase" wording).
"""
...
def build_report(queries: list[QueryCase], metrics: dict[str, StrategyMetrics], k: int) -> str:
    ...
    lines = [
        "# Phase 6 Retrieval Evaluation Report",
        "",
        "## Scope",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="(deprecated) Legacy runner. Use run_retrieval_benchmark.py with retrieval_metrics.py")
